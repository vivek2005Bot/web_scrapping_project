...
def index():
    if request.method == 'POST':
        try:
            ...
            uri = "mongodb+srv://Vivekkumar:M2QbrxTpSC9K#-q@cluster0.rdtbb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
            ...
            review_col_data=db['review_scrap_data']
            review_col_data.insert_many(reviews)
